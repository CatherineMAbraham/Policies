...
IFS=',' read -r SCRIPT YOUNGSTYPE <<< "$PARAM_LINE"

# Run the script
srun --export=ALL python $SCRIPT --threshold_pos 0.0005 --threshold_ori 0.5 --action_type euler --maxforce 4 --youngs_modulus_type $YOUNGSTYPE --softtissue spring --contact_type 0 --render_mode 'direct'  --log 1