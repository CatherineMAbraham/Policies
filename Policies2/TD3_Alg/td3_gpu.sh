...
# Run the script 
srun --export=ALL $PYTHON_EXEC td3_soft.py --threshold_pos 0.0005 --threshold_ori 0.5 --action_type euler --maxforce 3 --num_springs 3 --softtissue spring --youngs_modulus_type None --contact_type 1 --seed 1 --ran 1
