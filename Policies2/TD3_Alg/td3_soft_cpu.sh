...
# Run the script
srun --export=ALL $PYTHON_EXEC td3_soft.py --threshold_pos 0.0005 --threshold_ori 0.5 --action_type euler --maxforce 4 --softtissue spring --youngs_modulus_type $YM_TYPE --contact_type $CONTACT --seed $SEED --render_mode 'direct' --log 1 --ran $TASK_ID
