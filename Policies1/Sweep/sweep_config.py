...
sweep_config = {"method": "random",
    ...
    "parameters": {
    "learning_rate": {"values": [1e-5,3e-5,7e-4,1e-4,3e-4,1e-3,3e-3], "distribution": "categorical"},
    ...
    "action_noise": {"values": ["normal","OU"], "distribution": "categorical"},
}
...
sweep_id = wandb.sweep(sweep_config, project="Chapter2-Sweep", entity="cmabraham1-university-of-sheffield")
