...
# Run the script 
srun --export=ALL $PYTHON_EXEC td3_v1.py --threshold_pos 0.0005 --threshold_ori 0.5 --action_type euler --maxforce 5 --softtissue spring --num_springs 3 --youngs_modulus 5e5 --contact_type 0 --seed 5 --log 1 --render_mode 'direct'
