...
def train(threshold_pos=0.001, 
    ...
    env = make_vec_env('anklesurg-v2', env_kwargs=env_kwargs, n_envs=1,vec_env_cls=DummyVecEnv, seed=seed)
    ...
    eval_env_kwargs = {
            ...
            'width': 'None',
            'render_mode': None}
    eval_env=make_vec_env('gym_fracture:anklesurg-v2', env_kwargs=eval_env_kwargs,vec_env_cls=SubprocVecEnv)
