...
# Run the script
#srun --export=ALL 
python td3_v1_test.py --threshold_pos 0.001 --threshold_ori 1 --action_type euler --maxforce 5 --softtissue spring --num_springs 3 --youngs_modulus 1e6 --contact_type 0 --seed 5 --log 1 --render_mode 'direct'